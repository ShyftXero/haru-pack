#!/usr/bin/env python3
"""haru-pack: append a payload blob + fixed footer to a launcher PE.
Footer (68B, little-endian) matches docs/PLAN.md and src/overlay.nim:
  magic "HARUPACK"(8) | format_ver u16 | flags u16 |
  payload_off u64 | payload_len u64 | payload_sha256(32) | tail "KCAPURAH"(8)
